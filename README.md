...
Я використовував CLion для розробки, але якщо потрібно можна з консолі
```
...
І бінарник буде знаходитись в `build/Debug` або `build/Release`
...
3. Вроді знання ООП я гарно показав але. Багато нюансів це я знаю. Наприклад
 ...
 - В AppState можна винести обробку колізій в якусь окрему функцію або класс. В іншому портфоліо я використовував QuadTree для пошуку об'єктів колізії.
